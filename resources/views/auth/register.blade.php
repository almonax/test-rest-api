                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6 offset-md-3 text-center">
                            <img id="reg-avatar-preview" src="/img/avatar-not-found.png" class="img-circle avatar-shadow" alt="">
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" minlength="11" maxlength="11" required>
