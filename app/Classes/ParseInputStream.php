...
class ParseInputStream
{
    ...
    private function blocks($array)
    {
        $results = [];
        $paramsSeparator = "\r\n\r\n";
//        $paramsSeparatorLength = strlen($paramsSeparator);
        foreach($array as $key => $value)
        {
            ...
            foreach ( $block['parameters'] as $key => $val ) {
                /* fix for remove content length from input params value */
//                $val = substr($val, strpos($val, $paramsSeparator) + $paramsSeparatorLength);
